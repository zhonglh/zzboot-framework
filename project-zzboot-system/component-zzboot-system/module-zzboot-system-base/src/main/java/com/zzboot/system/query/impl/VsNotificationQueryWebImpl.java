...
*/
public class VsNotificationQueryWebImpl<PK extends Serializable> extends VsNotificationAbstractQueryImpl<PK> implements Serializable {
        ...
        //todo TIMESTAMP readTime;
            ...
            private String sendName_IN;
            private String sendName_NOTIN;



            private String receiveName_IN;
            private String receiveName_NOTIN;
            ...
            public String getSendName_NE() {
                return sendName_NE;
            }

            public void setSendName_NE(String sendName_NE) {
                this.sendName_NE = sendName_NE;
            }

            public String getSendName_IN() {
                return sendName_IN;
            }

            public void setSendName_IN(String sendName_IN) {
                this.sendName_IN = sendName_IN;
            }

            public String getSendName_NOTIN() {
                return sendName_NOTIN;
            }

            public void setSendName_NOTIN(String sendName_NOTIN) {
                this.sendName_NOTIN = sendName_NOTIN;
            }

            public String getSendName_LIKE() {
                return sendName_LIKE;
            }

            public void setSendName_LIKE(String sendName_LIKE) {
                this.sendName_LIKE = sendName_LIKE;
            }

            public String getSendName_NOTLIKE() {
                return sendName_NOTLIKE;
            }

            public void setSendName_NOTLIKE(String sendName_NOTLIKE) {
                this.sendName_NOTLIKE = sendName_NOTLIKE;
            }
            ...
            public String getReceiveName_NE() {
                return receiveName_NE;
            }

            public void setReceiveName_NE(String receiveName_NE) {
                this.receiveName_NE = receiveName_NE;
            }

            public String getReceiveName_IN() {
                return receiveName_IN;
            }

            public void setReceiveName_IN(String receiveName_IN) {
                this.receiveName_IN = receiveName_IN;
            }

            public String getReceiveName_NOTIN() {
                return receiveName_NOTIN;
            }

            public void setReceiveName_NOTIN(String receiveName_NOTIN) {
                this.receiveName_NOTIN = receiveName_NOTIN;
            }

            public String getReceiveName_LIKE() {
                return receiveName_LIKE;
            }

            public void setReceiveName_LIKE(String receiveName_LIKE) {
                this.receiveName_LIKE = receiveName_LIKE;
            }

            public String getReceiveName_NOTLIKE() {
                return receiveName_NOTLIKE;
            }

            public void setReceiveName_NOTLIKE(String receiveName_NOTLIKE) {
                this.receiveName_NOTLIKE = receiveName_NOTLIKE;
            }
}