...
public final class SearchFilterHelper {
     ...
     * @return
     */
    public static SearchFilter newCondition(final String key, final Object value) throws BizException {
     ...
     * @return
     */
    public static SearchFilter newCondition(final String searchProperty, final EnumSearchOperator operator, final Object value) {
