...
public class TsDepEntity extends BaseBusinessExEntity<String> implements java.io.Serializable{
    ...
    @EntityAttrFkAnnotation(group = "pid",  groupName = "上级部门" ,   dbColumnName = "id" , dbColumnType = "CHAR" , dbColumnLength = 32   , dbColumnNotNull = true , fkClass= TsDepBO.class)
    ...
    @EntityAttrFkAnnotation(group = "leadUserId",  groupName = "负责人" ,   dbColumnName = "id" , dbColumnType = "CHAR" , dbColumnLength = 32   , dbColumnNotNull = true , fkClass= TsUserBO.class)
